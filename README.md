...
This directory is the entire site: configuration, theme overrides, the React landing page, and the markdown content under `docs/`. The Docusaurus build emits a static site that is published from the repo via GitHub Pages.
