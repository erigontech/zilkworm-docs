...
//
// tsconfig.json inlines @docusaurus/tsconfig's compilerOptions instead
...
if (!Object.hasOwn(upstream, 'baseUrl')) {
  console.log(
    ...
    'in tsconfig.json (keeping "strict": true) and delete this script.',
  );
}

if (problems.length > 0) {
  console.error(
    'check-tsconfig-drift: tsconfig.json has drifted from @docusaurus/tsconfig:\n' +
    problems.join('\n') +
